...
import {Card, ListGroup, ListGroupItem, Accordion, Button, CardDeck, Row, Col, Container} from 'react-bootstrap';
            ...
            <Container fluid className='container-fluid d-flex justify-content-center'>
                <Row>
                    {filteredReview.map((review) => {
                        return (
                            <Col lg={true} className=' m-3 col-md-3 col-sm-12' key={review.id}>
                                <Card style={{width: '18rem'}} className=' h-100 review-card '>
                                    <Card.Body>
